...
import com.theater.system.command.TheaterSection;
import com.theater.system.main.TheatreSeating;
/**
 * This is the implementation class to get the theater ticket request,layout and processs the service.
 * 
 * @author Harsh Shukla
 */
public class TheaterSeatingServiceImpl implements TheaterSeatingService {
	...
	/**
	 * Process the raw layout received from input file, and create the theater layout by populating the section details
	 * Add all these items to the bean.
	 * @param rawLayout
	 */
    @Override
    public TheaterLayout getTheaterLayout(String rawLayout) throws NumberFormatException{
    	LOGGER.info("Process the raw layout received from input file, and create the theater layout by populating the section details");
    ...
    /**
	 * Populate the ticket request List with various ticket request received from input file
	 * 
	 * @param ticketRequests
	 * @return List<TheaterRequest>
	 */
    
    @Override
    public List<TheaterRequest> getTicketRequests(String ticketRequests) throws NumberFormatException{
    	LOGGER.info("Populate the ticket request List with various ticket request received from input file");
        ...
        for(String r : requests){
            ...
            try{
            	...
            	LOGGER.severe("Could not create the theater ticket requests. " + nfe.getMessage());
     ...
     * @params List<TheaterRequest> requests, int complementSeats, int currentRequestIndex
    ...
    private int findComplementRequest(List<TheaterRequest> requests, int complementSeats, int currentRequestIndex){
    	LOGGER.info("Find complementing request to avoid waste of seats");
        int requestNo = -1;
     ...
     *      @param TheaterLayout layout, List<TheaterRequest> requests
     * 
     */
